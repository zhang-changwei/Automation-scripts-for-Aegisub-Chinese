...
--Script properties
script_name="C Gradient-渐变"
script_description="Gradient v2.2 - 汉化版"
...
local dialog_config={
    ...
    {class="checkbox",name="set",label="模式选择",value=false,x=0,y=0,hint="勾选：时间模式，不勾选：行模式。\n true: time mode, false: line mode \n 英文名称setting"},
    {class="dropdown",name="mode",items={"replace","append"},value="replace",width=3,x=1,y=0,hint=" replace 替换模式\n append 增加模式"},

    {class="label",label="标签定位规则",x=0,y=1,hint="英文名称rule"},
    {class="edit",name="rule",value="11",width=3,x=1,y=1,hint="%d%d[ht]?,%d%d[ht]?... e.g. 12h,21t\n以12h为例：{1}这是{2}一条{3}示例,1代\n表第一个被{}包裹的标签块,2代表第一个\n标签快中的第二个\\c标签,下面举一个例\n子{\\c0000FF\\pos(0,0)\\t(\\cFF0000)},\\t()\n里的\\ccFF0000就是2要代表的标签,h 和\nt，h表示在标签块的开头添加，t表示在\n标签块的结尾增加。"},
    {class="label",label="加速度值",x=0,y=2,hint="英文名称accel"},
    {class="floatedit",name="accel",value=1,width=3,x=1,y=2},

    {class="checkbox",name="color_cb",label="颜色",value=false,x=1,y=3,hint="英文名称color"},
    {class="dropdown",name="color",items={"c","1c","2c","3c","4c","1vc","2vc","3vc","4vc"},value="c",x=1,y=4},
    {class="checkbox",name="alpha_cb",label="透明",value=false,x=2,y=3,hint="英文名称alpha"},
    {class="dropdown",name="alpha",items={"alpha","1a","2a","3a","4a","1va","2va","3va","4va"},value="alpha",x=2,y=4},
    {class="checkbox",name="other_cb",label="其他",value=false,x=3,y=3,hint="英文名称others"},
    {class="dropdown",name="other",items={"pos","fscx","fscy","fsc","fsp","fsvp","frz","frx","fry","fax","fay","bord","shad","xshad","yshad","blur","t1","t2","clip"},value="pos",x=3,y=4,hint="仅支持矢量剪辑。\n only vector clip supported"},
    --note
    {class="label",x=0,y=5,label="下拉菜单:"},
    {class="label",x=1,y=5,width=4,height=2,
      label="替换：在每个选定的行中应包含所设定的标签 \n"..
            "增加：保留原始标签，并在头/尾部添加新标签"},
    {class="label",x=0,y=7,label="定位规则:"},
    {class="label",x=1,y=7,width=4,label="\\d\\d[ht]?,\\d\\d[ht]?... 用','分开 12t，21h"},
    {class="label",x=0,y=8, width=2,label="    [第一个数字]:"},
    {class="label",x=0,y=9, width=2,label="    [第二个数字]:"},
    {class="label",x=0,y=11,width=2,label="    [第三个[ht]?]:"},
    {class="label",x=2,y=8,width=3,label="第一个数字，标签块数，从1开始。"},
    {class="label",x=2,y=9,width=3,height=2,label="第二个数字，所有标签块中需渐变的标签在\n第几标签块，从1开始，应计算\\t()中的标签。"},
    {class="label",x=2,y=11,width=3,height=2,label="将标签添加到标签块的头/尾，仅在'追加'模\n式下有效，默认值为'h'。\n\n执行    退出"},
